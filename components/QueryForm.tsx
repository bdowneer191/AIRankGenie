...
import { Search, Plus, X, Globe, Smartphone, Monitor, Sparkles, Bot } from 'lucide-react';
      ...
      <CardContent className="space-y-8 pt-8">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-gray-500 mt-1">
            {searchMode === 'google' && "Track standard organic rankings & 'AI Overview' snippets."}
            {searchMode === 'google_ai_mode' && "Track citations inside Google's dedicated AI Mode results."}
            {searchMode === 'google_ask_ai' && "Monitor answers generated by Google's 'Ask AI' feature."}
          </p>
        </div>
        ...
        <div className="pt-4 border-t border-gray-100">
          ...
          >
            {isLoading ? "Initializing Job..." : `Start Tracking ${queries.length > 0 ? `(${queries.length} keywords)` : ''}`}
          </Button>
        </div>
